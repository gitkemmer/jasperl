...
package Method::Generate::Accessor::Role::JasPerl::Role;

# VERSION

use Moo::Role;

with qw(Method::Generate::Accessor::Role::JasPerl::Bean);
...
Method::Generate::Accessor::Role::JasPerl::Role - <One line description of module's purpose>

=head1 SYNOPSIS

use Method::Generate::Accessor::Role::JasPerl::Role;
