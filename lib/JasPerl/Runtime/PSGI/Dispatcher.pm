...
package JasPerl::Runtime::PSGI::Dispatcher;

# VERSION

use JasPerl::Util::Bean;

with qw(JasPerl::RequestDispatcher);

# FIXME: include/forward wrapping, params

has _page => ( is => 'ro', init_arg => 'page' );

sub forward {
    my ($self, $request, $response) = @_;
    $self->_page->service($request, $response);
}
...
JasPerl::Runtime::PSGI::Dispatcher - <One line description of module's purpose>
