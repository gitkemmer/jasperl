...
package JasPerl::TagExt::TagAttributeInfo;
...
has [ qw(required fragment) ] => ( is => 'ro', boolean => 1 );

has rtexprvalue => ( is => 'ro', reader => 'can_be_request_time' );
...
JasPerl::TagExt::TagAttributeInfo - <One line description of module's purpose>
