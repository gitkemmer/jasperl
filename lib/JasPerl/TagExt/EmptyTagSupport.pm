...
package JasPerl::TagExt::EmptyTagSupport;
...
use constant BODY_CONTENT => 'empty';
...
JasPerl::TagExt::EmptyTagSupport - <One line description of module's purpose>

=head1 SYNOPSIS

use JasPerl::TagExt::EmptyTagSupport;
