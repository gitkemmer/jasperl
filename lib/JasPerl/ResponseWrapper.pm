...
package JasPerl::ResponseWrapper;
...
JasPerl::ResponseWrapper - <One line description of module's purpose>

=head1 SYNOPSIS

use JasPerl::ResponseWrapper;
