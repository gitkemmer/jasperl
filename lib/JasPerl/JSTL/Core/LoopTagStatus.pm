...
has [ qw(current) ] => ( is => 'rwp' );

has [ qw(begin end step) ] => ( is => 'rwp' );

has [ qw(index count) ] => ( is => 'rwp' );

has [ qw(first last) ] => ( is => 'rwp', boolean => 1 );
...
JasPerl::JSTL::Core::LoopTagStatus - <One line description of module's purpose>
