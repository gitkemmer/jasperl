...
package JasPerl::TagLib::JSTL;

use JasPerl::TagLib::JSTL::Core;
#use JasPerl::TagLib::JSTL::Fmt;
#use JasPerl::TagLib::JSTL::SQL;
#use JasPerl::TagLib::JSTL::XML;
#use JasPerl::TagLib::JSTL::Functions;
...
JasPerl::TagLib::JSTL - <One line description of module's purpose>

=head1 SYNOPSIS

use JasPerl::TagLib::JSTL;
