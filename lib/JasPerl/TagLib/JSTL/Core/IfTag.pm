...
package JasPerl::TagLib::JSTL::Core::IfTag;

# VERSION

use JasPerl::TagExt::Tag;

with qw(JasPerl::JSTL::Core::ConditionalTagSupport);

has test => ( rt => 1, required => 1, boolean => 1 );
...
JasPerl::TagLib::JSTL::Core::IfTag - <One line description of module's purpose>

=head1 SYNOPSIS

use JasPerl::TagLib::JSTL::Core::IfTag;
