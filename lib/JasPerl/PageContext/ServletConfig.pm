...
package JasPerl::PageContext::ServletConfig;
...
sub get_init_parameter {
    return ${$_[0]}->get_init_parameter($_[1]);
}

sub get_init_parameter_names {
    return ${$_[0]}->get_init_parameter_names();
}

sub get_servlet_context {
    return ${$_[0]}->get_servlet_context();
}

sub get_servlet_name {
    return ref ${$_[0]}->get_page();
}
...
JasPerl::PageContext::ServletConfig - <One line description of module's purpose>

=head1 SYNOPSIS

use JasPerl::PageContext::ServletConfig;
