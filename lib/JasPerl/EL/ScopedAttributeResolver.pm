...
package JasPerl::EL::ScopedAttributeResolver;
...
has jspContext => ( is => 'ro', required => 1, weak_ref => 1 );
...
JasPerl::EL::ScopedAttributeResolver - <One line description of module's purpose>

=head1 SYNOPSIS

use JasPerl::EL::ScopedAttributeResolver;
