...
package JasPerl::EL::VariableResolver;

# VERSION

use JasPerl::Util::Role;

requires qw(resolve_variable);
...
JasPerl::EL::VariableResolver - <One line description of module's purpose>

=head1 SYNOPSIS

use JasPerl::EL::VariableResolver;
