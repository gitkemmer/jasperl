...
package JasPerl::EL::FunctionMapper;

# VERSION

use JasPerl::Role;

requires qw(resolve_function);
...
JasPerl::EL::FunctionMapper - <One line description of module's purpose>

=head1 SYNOPSIS

use JasPerl::EL::FunctionMapper;
