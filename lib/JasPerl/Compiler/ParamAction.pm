...
package JasPerl::Compiler::ParamAction;
...
has value => ( required => 1, rtexprvalue => 1 );

sub do_tag {
    my $self = shift;
    my $parent = $self->get_parent();
    die "invalid parent" unless $parent->can('add_parameter');
    $parent->add_parameter($self->get_name(), $self->get_value());
}
...
JasPerl::Compiler::ParamAction - <One line description of module's purpose>

=head1 SYNOPSIS

use JasPerl::Compiler::ParamAction;
