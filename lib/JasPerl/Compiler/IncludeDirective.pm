...
package JasPerl::Compiler::IncludeDirective;
...
sub do_tag {
    $_[0]->get_jsp_context()->include($_[0]->get_file());
}
...
JasPerl::Compiler::IncludeDirective - <One line description of module's purpose>

=head1 SYNOPSIS

use JasPerl::Compiler::IncludeDirective;
